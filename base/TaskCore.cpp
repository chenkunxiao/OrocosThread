...
namespace RTT {
    ...
    bool TaskCore::configure() {
        if ( mTaskState == Stopped || mTaskState == PreOperational) {
            try {
                ...
                cout << "in configure(): switching to exception state because of unhandled exception" << endl;
                cout << "  " << e.what() << endl;
                exception();
            } catch(...) {
                cout << "in configure(): switching to exception state because of unhandled exception" << endl;
    ...
    bool TaskCore::cleanup() {
        if ( mTaskState == Stopped ) {
            try {
                ...
                cout << "in cleanup(): switching to exception state because of unhandled exception" << endl;
                cout << "  " << e.what() << endl;
                exception();
            } catch (...) {
                cout << "in cleanup(): switching to exception state because of unhandled exception" << endl;
    ...
    void TaskCore::exception() {
        ...
        try {
            ...
            cout << "stopHook(), cleanupHook() and/or exceptionHook() raised " << e.what() << ", going into Fatal" << endl;
            fatal();
        }
        catch (...) {
            cout << "stopHook(), cleanupHook() and/or exceptionHook() raised an exception, going into Fatal" << endl;
            fatal();
        }
    }
    ...
    bool TaskCore::start() {
        if ( mTaskState == Stopped ) {
            try {
                ...
                cout << "in start(): switching to exception state because of unhandled exception" << endl;
                cout << "  " << e.what() << endl;
                exception();
            } catch (...) {
                cout << "in start(): switching to exception state because of unhandled exception" << endl;
    ...
    bool TaskCore::stop() {
        ...
        if ( mTaskState >= Running ) {
            try {
                ...
                cout << "in stop(): switching to exception state because of unhandled exception" << endl;
                cout << "  " << e.what() << endl;
                exception();
            } catch (...) {
                cout << "in stop(): switching to exception state because of unhandled exception" << endl;
