...
namespace RTT
{
     ...
     * @ingroup CoreLibProperties
     */
    base::PropertyBase* findProperty(const PropertyBag& bag, const std::string& path, const std::string& separator = std::string(".") );
     ...
     * @ingroup CoreLibProperties
     */
   std::vector<std::string> listProperties( const PropertyBag& bag, const std::string& separator = std::string("."));
     ...
     * @ingroup CoreLibProperties
     */
    std::vector<std::string> listPropertyDescriptions( const PropertyBag& bag, const std::string& separator = std::string("."));
